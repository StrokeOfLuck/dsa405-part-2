...
log_html='<details id="cleaning-log"><summary>Cleaning log · '+str(len(log))+' decisions</summary><p>One entry per decision, including retention, rationale, measured effects and reversal instructions. Generated from notebook section 3.</p>'+''.join('<details class="dictionary-entry"><summary>'+html.escape(r['#']+'. '+r['change made'])+'</summary>'+details(r)+'</details>' for r in log)+'<a href="data/cleaning_log.csv" download>Download cleaning log CSV</a></details>'
